...
fn print_hypotheses(report: &Report, replay_equal: bool) {
    ...
    println!(
        ...
        report.max_default_score_error <= TOLERANCE
            && report.max_extended_score_error <= TOLERANCE
    );
    println!(
...
fn fixture() -> (Vec<CcosNode>, Vec<CausalEdge>) {
    let specs = [
        NodeSpec { id: "file:failure.rs", base: 0.90, failure: 0.95, recency: 1.00, access: 8, trust: 1.00, lifecycle: Lifecycle::Working, fill: 'A', chars: 144 },
        NodeSpec { id: "file:db.rs", base: 0.80, failure: 0.05, recency: 0.90, access: 12, trust: 1.00, lifecycle: Lifecycle::Stable, fill: 'B', chars: 120 },
        NodeSpec { id: "file:api.rs", base: 0.65, failure: 0.00, recency: 0.70, access: 3, trust: 0.90, lifecycle: Lifecycle::Stable, fill: 'C', chars: 96 },
        NodeSpec { id: "file:cache.rs", base: 0.55, failure: 0.10, recency: 0.60, access: 2, trust: 0.75, lifecycle: Lifecycle::Stable, fill: 'D', chars: 112 },
        NodeSpec { id: "file:old.rs", base: 0.30, failure: 0.00, recency: 0.10, access: 1, trust: 1.00, lifecycle: Lifecycle::Orphan, fill: 'E', chars: 80 },
        NodeSpec { id: "file:worker.rs", base: 0.70, failure: 0.02, recency: 0.85, access: 20, trust: 0.60, lifecycle: Lifecycle::Stable, fill: 'F', chars: 128 },
        NodeSpec { id: "file:parser.rs", base: 0.75, failure: 0.00, recency: 0.50, access: 5, trust: 0.25, lifecycle: Lifecycle::Stable, fill: 'G', chars: 88 },
        NodeSpec { id: "dep:std", base: 0.95, failure: 0.00, recency: 1.00, access: 30, trust: 1.00, lifecycle: Lifecycle::Stable, fill: 'H', chars: 64 },
        NodeSpec { id: "file:model.rs", base: 0.60, failure: 0.15, recency: 0.40, access: 7, trust: 0.85, lifecycle: Lifecycle::Stable, fill: 'I', chars: 136 },
        NodeSpec { id: "file:root.rs", base: 0.85, failure: 0.00, recency: 0.75, access: 10, trust: 1.00, lifecycle: Lifecycle::Stable, fill: 'J', chars: 104 },
    ];
